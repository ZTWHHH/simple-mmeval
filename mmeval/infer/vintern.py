...
class TaskRunner(Task):
    def __init__(self, args):
        ...
        self.default_model_kwargs = {"torch_dtype": torch.bfloat16, "low_cpu_mem_usage": True}
        self.default_gen_kwargs = {"max_new_tokens": 1024, "do_sample": False, "num_beams": 3, "repetition_penalty": 2.5}
