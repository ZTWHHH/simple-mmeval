...
python $MMEVAL_DIR/mmeval/run.py \
    --infile $MMEVAL_DIR/tests/samples/multi_image_video_interleave.json \
    --dataset local@json \
    --out_dir $RESULT_DIR/work_dirs/qwen3-vl/Qwen3-VL-235B-A22B-Instruct-multi-image-video-interleave \
    --img_dir $MMEVAL_DIR/tests/media/448 \
...
#     --infile $MMEVAL_DIR/tests/samples/multi_image_video_interleave.json \
#     --dataset local@json \
#     --out_dir $RESULT_DIR/work_dirs/qwen3-vl/Qwen3-VL-32B-Thinking-multi-image-video-interleave \
#     --img_dir $MMEVAL_DIR/tests/media/448 \
...
#     --infile $MMEVAL_DIR/tests/samples/multi_image_video_interleave.json \
#     --dataset local@json \
#     --out_dir $RESULT_DIR/work_dirs/qwen3-vl/Qwen3-VL-235B-A22B-Thinking-multi-image-video-interleave \
#     --img_dir $MMEVAL_DIR/tests/media/448 \
