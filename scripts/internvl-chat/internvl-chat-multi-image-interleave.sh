...
python $MMEVAL_DIR/mmeval/run.py \
    ...
    --dataset local@json \
    --out_dir $RESULT_DIR/work_dirs/internvl-chat/InternVL-Chat-V1-1-multi-image-interleave \
...
python $MMEVAL_DIR/mmeval/run.py \
    --infile $MMEVAL_DIR/test_bed/modality_test/task/multi_image_interleave.json \
    --dataset local@json \
    --out_dir $RESULT_DIR/work_dirs/internvl-chat/InternVL-Chat-V1-2-multi-image-interleave \
    --img_dir $MMEVAL_DIR/test_bed/modality_test/media/448 \
...
python $MMEVAL_DIR/mmeval/run.py \
    --infile $MMEVAL_DIR/test_bed/modality_test/task/multi_image_interleave.json \
    --dataset local@json \
    --out_dir $RESULT_DIR/work_dirs/internvl-chat/InternVL-Chat-V1-2-Plus-multi-image-interleave \
    --img_dir $MMEVAL_DIR/test_bed/modality_test/media/448 \
